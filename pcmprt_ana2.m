...
%          to the femur and tibia, MASKROI, array of slices with
%          segmentations, RSL, the number of slices with segmentations,
%          NRSLS, cell array with slices in the femur and tibia, RSLBS,
%          vector of spin lock/echo times, TIME, the number of spin
%          lock/echo times, NTIME, a function handle, FUN, to evaluate
%          the monoexponential and its derivatives, and initialization
%          flag, INIT, to determine the initial starting parameters,
