...
%
%             3.  M-files InterX.m, coord_tf.m, cr_mask2.m, cr_maskfc.m,
...
%             lsect5.m, midline.m, mk_lay_msks.m, mk_tri_2dc.m,
%             mk_tri_2dfc.m, mk2_tri_2d.m, mk2_tri_2df.m, mtch_ends.m,
%             near2.m, plane_fit.m, plnorm.m, plsect.m, plsect2.m,
%             plt_datsl.m, pts2lin.m, pt2line.m, rb_trnsf.m, rd_prois.m,
%             rd_roi6.m, rotxyz.m, tib_plan.m, tibia_cs8.m, tri2d.m,
%             tri_area.m, and trim_seg.m must be in the current
%             directory or path.
%
...
%
   ...
   fnam = d.name;
%
   [xyzt,rtmat] = tibia_cs8(fullfile(rdir,fnam),ileg,iplt2);
%
   if iplt2
     view(3);
...
%
   ...
   save(savnam,'brois','f','f3','f3f','fs','ibone','leg','maskf', ...
        ...
        't3','t3t','t3tt','tplan_pts','tplan_nvs','xyzc','xyzt');
%
