...
%
diste = 2*dist;         % Two distance from cartilage end points to line of bone points
...
if d>dist2
  ...
  if id1>npts2/2        % Intersection at other end of femoral bone?
    itrap1 = true;
    id1sav = id1;
    xy3 = xy2;
    id1 = 1;
...
if d>dist2
  ...
  if id2<npts2-npts2/2  % Intersection at other end of femoral bone?
    itrap2 = true;
    id2sav = id2;
    xy3 = xy2;
    id2 = npts2-1;
